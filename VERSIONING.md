...
The registry uses semantic versioning adapted to a controlled vocabulary.

## Version numbers

- **Major (`X.0.0`)** — a breaking change to identifiers, core meanings, or required interpretation. Major changes are strongly disfavored.
