...
Girişler, korpusu okuyan modelin okumasından çıkarıldı ve tekrar testine sokuldu; geriye korpusun üretmekten vazgeçmediği yapılar kaldı. Kabul kararını insan verir.

Tanınmış bir ad burada hiçbir şey kazandırmaz. `twin_crisis` kriz literatürünün yerleşik terimidir ve sicilde yoktur: mevcut girişler onu nedensel kayıp olmadan temsil ediyor. Bir kimlik literatürdeki bir terimle aynı adı taşıyorsa bu yakınsamadır — aynı yapıya iki ayrı yoldan varmak.

Genelleşen kısım yöntemdir; finans-öncelikli otuz iki giriş onun ilk örneğidir. [DISTILLATION.tr.md](DISTILLATION.tr.md) döngüyü, rolleri ve kapsamı verir.
...
└── LICENSE.md                insan-okur lisans bildirimi
```

## Sicilden imzaya

Belirli bir an için puanlandığında sicil kompakt bir dünya durumuna dönüşür: her giriş 0–100 arası bir şiddet, bir yön ve mekanizma yoksa gerekçeli bir sıfır taşır. Tarihsel karşılaştırmayı, analog aramayı, negatif uzay incelemesini, tarihli kamusal okumaları ve bir dil modeline uzun anlatı vermeden bağlam yüklemeyi taşıyan şey bu vektördür.
...
**adenkarabal** araştırmayı yürütür ve yayımlanan hükümlerin sorumluluğunu taşır. **Claude by Anthropic** sentez, eleştiri ve karşı okumaya; **OpenAI Codex** araştırma mimarisi, doğrulama, uygulama ve editoryal geliştirmeye katkıda bulunur. Çalışma kaydı [PROVENANCE.md](PROVENANCE.md) dosyasındadır.

## Eleştiri ve kullanım

Sınır itirazları, öncül çalışmalar, karşı örnekler ve başarısız uygulamalar issue'lara; şablonlar her itirazı ilgili mekanizmaya ve sürüme bağlar. [MECHANISMS.md](MECHANISMS.md)'deki sınırlar, sicilin sınanmaya en değer yeridir.

Atıf bilgileri [CITATION.cff](CITATION.cff) dosyasındadır. Sicil ve belgeler [CC BY 4.0](LICENSE.md) altında kullanılabilir.
